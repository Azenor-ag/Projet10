...
class HMWP_Controllers_SecurityCheck extends HMWP_Classes_FrontController
{
    ...
    public function action()
    {
        ...
        case 'hmwp_frontendcheck':
	        ...
	        //set hmwp_brokenfiles to false and not load the broken paths with WordPress rules
	        $url = _HMWP_URL_ . '/view/assets/img/logo.png?hmwp_brokenfiles=0&test=' . mt_rand(11111,99999);
